...
import { getDirectionIcon } from '../../sevenSamplesOption';
...
export interface YgSamplePricesPanelProps {
  option: any;
...
const YgSamplePricesPanel: React.FC<YgSamplePricesPanelProps> = ({
  option,
  cols,
  tableRows,
  hbLabel,
...
export default YgSamplePricesPanel;
