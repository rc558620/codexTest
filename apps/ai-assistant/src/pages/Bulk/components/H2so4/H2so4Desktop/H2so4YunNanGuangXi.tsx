...
import AveragePriceYn from '../components/AveragePriceYn';
import Sour from '../components/Sour';
import SpotPriceYn from '../components/SpotPriceYn';

interface H2so4NationwideProps {}

const H2so4YunNanGuangXi: React.FC<H2so4NationwideProps> = () => {
  return (
    <div className="page__inner">
      ...
      <div className="grid grid--2">
        ...
        <AveragePriceYn title="云南硫酸均价、磷酸氢钙17%价、硫铁矿价" />
      </div>
      <div className="grid grid--2">
        <Sour title="酸企周产量" />
        <SpotPriceYn title="云南及广西98%硫酸价格" />
      </div>
    </div>
  );
};

export default H2so4YunNanGuangXi;
