...
import { buildNh3IntlOption, getDirectionIcon, type LineSeries } from './nh3IntlOptionMobile';

interface TrendMobileProps {
  title: string;
...
const TrendMobile: React.FC<TrendMobileProps> = ({
  title,
  dates = DATES,
  ...
  const cols: ColumnsType<Row> = [
    { title: '时间', dataIndex: '时间', width: 50, fixed: 'left', align: 'center' },
  ...
  return (
    <div className="mobile-box">
      <div className="mobile-box-flex">
        ...
        <span className="mobile-box-flex-right">单位：$/吨 数据来源：百川</span>
      </div>
